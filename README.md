* [DAY 1](#day-1-design-preparation-and-synthesis-using-openlane-flow)
   * [Design prep](#design-prep)
   * [Synthesis results](#synthesis-results)
* [DAY 2](#day-2)
   * [run_floorplan](#run_floorplan)
   * [floorplan config:](#floorplan-config)
   * [Die area from floorplan DEF](#die-area-from-floorplan-def)
   * [floorplan snapshot](#floorplan-snapshot)
   * [equi-distance pins](#equi-distance-pins)
   * [horizontal metal 3](#horizontal-metal-3)
   * [Standard cells in lower left corner (origin)](#standard-cells-in-lower-left-corner-origin)
   * [Placement](#placement)
      * [With default configuration](#with-default-configuration)
      * [Timing driven placement](#timing-driven-placement)
      * [What happens when PL_ROUTABILITY_DRIVEN and PL_TIME_DRIVEN are set to true?](#what-happens-when-pl_routability_driven-and-pl_time_driven-are-set-to-true)
      * [Routability driven](#routability-driven)
* [DAY 3](#day-3)
   * [Some DRC issues with sky130_inv layout (unchanged)](#some-drc-issues-with-sky130_inv-layout-unchanged)
   * [generate spice from layout](#generate-spice-from-layout)
   * [Spice netlist (unchanged)](#spice-netlist-unchanged)
   * [grid size:](#grid-size)
   * [SPICE netlist after extraction](#spice-netlist-after-extraction)
   * [Run ngspice (install using sudo apt install ngspice)](#run-ngspice-install-using-sudo-apt-install-ngspice)
   * [4 important parameters to measure from the output waveform:](#4-important-parameters-to-measure-from-the-output-waveform)
   * [conditions:](#conditions)
   * [pin definitions](#pin-definitions)
   * [Custom cell placed in design](#custom-cell-placed-in-design)
* [Day 4](#day-4)
   * [Post-Synthesis timing analysis with OpenSTA tool.](#post-synthesis-timing-analysis-with-opensta-tool)
   * [Run CTS](#run-cts)
   * [After CTS:](#after-cts)
   * [OPENROAD](#openroad)
   * [Clock skew for setup and hold:](#clock-skew-for-setup-and-hold)
* [DAY 5](#day-5)
   * [Routing gen_pdn](#routing-gen_pdn)
      * [pdn generated successfully](#pdn-generated-successfully)
   * [run_routing](#run_routing)
   * [SPEF file generated after routing is done](#spef-file-generated-after-routing-is-done)
